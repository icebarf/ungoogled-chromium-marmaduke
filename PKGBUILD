...
source=("${url}/releases/download/v142.7444.166-M${pkgver}-r1522585-portable-ungoogled-Lin64/ungoogled-chromium_${pkgver}_${pkgrel}.vaapi_linux.tar.xz"
    "icons.tar.xz"
    "chromium"
    "chromium.desktop"
        )
...
sha256sums=('d15734fb50aefe7b2677759e996626539146f2461c2733278db36d1eaf26c97d'
